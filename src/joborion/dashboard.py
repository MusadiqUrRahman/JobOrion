"""JobOrion HTML Dashboard Generator.
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.joborion/dashboard.html.
...
<title>JobOrion Dashboard</title>
<style>
