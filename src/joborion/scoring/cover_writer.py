...
from joborion.config import COVER_LETTER_DIR, RESUME_PATH, load_profile
...
VOICE:
- Write like a strong professional emailing someone they respect. Not formal, not casual. Just direct.
...
def write_cover_letters(min_score: int = 7, limit: int = 20,
