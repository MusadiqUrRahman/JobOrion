...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from joborion.discovery.jobspy import parse_proxy
...
def _load_base_urls() -> dict[str, str | None]:
    ...
    from joborion.config import load_base_urls
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from joborion.discovery.ai_scraper import extract_json
...
def enrich_jobs(limit: int = 100, workers: int = 1) -> dict:
